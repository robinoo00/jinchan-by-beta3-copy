...
export default {
    ...
    state: {
        ...
        limit_earn: {
            inputs: [
                {
                    text: '止损价格', placeholder: '请输入止损价格', name: 'tickLoss'
                },
                {
                    text: '止赢价格', placeholder: '请输入止赢价格', name: 'tickProfit'
                },
            ],
            data: {},
            visible: false,
    ...
    effects: {
        ...
        * del({params},{call}){
            const {data} = yield call(LimitServices.del,params)
            Toast.info(data.信息, 1)
        }
    },
